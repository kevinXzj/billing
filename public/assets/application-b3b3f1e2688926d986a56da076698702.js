...
(function() {
  $(".bill_import_logs.index").ready(function() {
    ...
    return $('#uploadBtn').click(function() {
      if ($('#company_id').val() === "") {
        return alert("请选择套餐");
      } else if ($('#year').val() === "") {
...
(function() {
  $(".company_import_logs.index").ready(function() {
    $('#lefile').change(function() {
      return $('#photoCover').val($(this).val());
    });
    $('#selectBtn').click(function() {
...
(function() {
  $(".issue_number_import_logs.index").ready(function() {
    $('#lefile').change(function() {
      return $('#photoCover').val($(this).val());
    });
    $('#selectBtn').click(function() {
